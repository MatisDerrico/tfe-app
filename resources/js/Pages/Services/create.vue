<template>
    ...
    <AuthenticatedLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Création de services</h2>
        </template>
                   ...
                   <form @submit.prevent="submit" class="flex flex-col">
                        ...
                        <div class="flex flex-col sm:flex-row sm:gap-6">
                            ...
                            <div class="w-1/8">
                                ...
                                <InputLabel class="mb-1 block text-sm font-medium leading-6 text-gray-900"value="price" />
                            ...
                            <div>
                                <InputLabel class="mt-4 mb-1 block text-sm font-medium leading-6 text-gray-900"value="duration" />
