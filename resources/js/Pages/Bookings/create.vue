            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-sm p-6 sm:rounded-lg">
                   <form @submit.prevent="submit" class="flex flex-col">
                            <div class="">
                                <InputLabel class="mb-1 block text-sm font-medium leading-6 text-gray-900" value="nom complet" />
                            ...
                            <div class="mt-4 bg-gray-300 px-2 py-4 text-center rounded-lg">
                                <div
                                ...
                                >
                                    <div class="flex">
                                        <h2>{{ service.name }}</h2>
                                        <p class="ml-4 font-bold">{{ service.price }} €</p>
                                    </div>
                                ...
                                <p class="mt-2">
                                    Total : <span class="font-bold">{{ form.price }} €</span>
                                </p>
                            </div>
